...
const units = ["kg", "piece", "liter", "gram", "ton", "box", "bag", "service", "hour", "day"]
...
export default function EditResourcePage() {
  ...
  const fetchResource = async () => {
    try {
      ...
      if (resourceData.supplierId !== user?._id && resourceData.supplierId !== user?.uid) {
      ...
      setFormData({
        ...
        currency: resourceData.pricing.currency,
        unit: resourceData.pricing.unit,
        minimumOrder: resourceData.pricing.minimumOrder,
        status: resourceData.availability.status,
        quantity: resourceData.availability.quantity,
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4 py-8">
          <Card className="w-full max-w-md mx-auto">
            ...
            <CardContent>
              <p>The resource you're trying to edit doesn't exist or you don't have permission to edit it.</p>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            ...
            <Card>
              <CardHeader>
                <CardTitle>Resource Images</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div>
